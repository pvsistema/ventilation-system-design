// ─────────────────────────────────────────────────────────────────────────────
// ventsimCsvImport.ts — CSV-ВЫГРУЗКА ИЗ VENTSIM DESIGN 5/6 (Branch Report).
//
// НЕ ПУТАТЬ: сам файл модели .vsm разбирает ventsimVsmImport.ts, и данных
// в нём БОЛЬШЕ — в CSV-выгрузке Ventsim нет ни сопротивлений, ни расходов.

...
export const CANVAS_THEME: Record<"light" | "dark", CanvasTheme> = {
  ...
  dark: {
    // Глубокий сине-серый, как в профессиональных САПР: не чёрный, чтобы
    // не резал глаза, и холоднее интерфейса — схема визуально «в глубине».
    bg2D: "#141922",
    bg3D: "linear-gradient(to bottom, #10151d 0%, #171d28 60%, #10151d 100%)",
    branchFill: "#2a3242",
  },
};

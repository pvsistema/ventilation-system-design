 ...
 * Берётся, если у выработки α не задан: такой Кз = 2·10⁻³ — середина таблицы.
 */
export const VGSCH_ALPHA_DEFAULT = 150;

/**
 * Коэффициент затухания Кз по табл. 3 — по коэффициенту аэродинамического
 * сопротивления выработки A, ×10⁻⁴ Н·с²/м⁴. В программе α хранится в тех же
 * единицах (справочник единиц: «×10⁻⁴ кг/м³» = Н·с²/м⁴), поэтому идёт как есть.
 */

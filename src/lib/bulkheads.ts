...
// Ускорение свободного падения — переводной множитель между расчётными
// единицами (Н·с²/м⁸, ΔP = R·Q² в Па) и рудничными кМюрг АэроСети
// (кгс·с²/м⁸, ΔP = R·Q²·g): R_расч = R_АэроСети · g.
// Живёт в lib/resistanceUnits.ts — здесь только ре-экспорт, чтобы прежние
// импорты из bulkheads продолжали работать и значение было ровно одно.

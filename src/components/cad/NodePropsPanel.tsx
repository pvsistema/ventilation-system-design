    ...
    <div className="flex flex-col" style={{ fontSize: 11 }}>
      ...
      {moved && (
        <div className="mx-1 my-1 px-2 py-1.5 rounded text-[10px] leading-snug"
          style={{ background: "var(--c-tint-amber, #fffbeb)", border: "1px solid #fcd34d", color: "var(--c-amber-ink, #92400e)" }}>
          ...
          {onResetToSurvey && (
            <button onClick={onResetToSurvey}
              ...
              style={{ background: "var(--c-s1, #fff)", border: "1px solid var(--c-amber, #d97706)", color: "var(--c-amber-ink, #92400e)", cursor: "pointer" }}>

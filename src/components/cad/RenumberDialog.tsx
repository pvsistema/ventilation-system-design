...
export default function RenumberDialog({ nodeCount, branchCount, horizons, onConfirm, onClose }: Props) {
  ...
  const S = {
    ...
    dialog: { width: 390, background: "var(--c-s1, #ffffff)", border: "1px solid var(--c-b3, #aaa)", borderRadius: 4, boxShadow: "0 8px 32px rgba(0,0,0,0.35)", fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--c-t1, #1a1a1a)" },

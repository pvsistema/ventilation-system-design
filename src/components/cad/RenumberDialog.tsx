...
export default function RenumberDialog({ nodeCount, branchCount, horizons, onConfirm, onClose }: Props) {
  ...
  const S = {
    ...
    dialog: { width: 390, background: "var(--c-s1, #ffffff)", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", boxShadow: "0 8px 32px rgba(0,0,0,0.35)", fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--c-t1, #1a1a1a)" },
    ...
    input: { width: 72, height: 22, padding: "0 4px", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", fontSize: 12, background: "var(--c-s1, #fff)", color: "var(--c-t1, #1a1a1a)", textAlign: "right" as const, outline: "none" },
    ...
    btnOk: { height: 26, padding: "0 20px", fontSize: 12, background: "var(--c-blue-bg, #2563eb)", color: "#fff", border: "1px solid var(--c-blue, #1d4ed8)", borderRadius: "var(--radius-ui)", cursor: "pointer", fontWeight: 600 },

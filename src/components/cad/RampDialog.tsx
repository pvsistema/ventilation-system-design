...
export default function RampDialog({
  ...
  const S = {
    ...
    dialog: { ...(pos ? { position: "fixed" as const, left: pos.x, top: pos.y, margin: 0 } : {}), width: 470, maxHeight: "88vh", overflowY: "auto" as const, background: "#fff", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", boxShadow: "0 8px 32px rgba(0,0,0,0.35)", fontFamily: "var(--font-ui)", fontSize: 12, color: "var(--c-t1, #1a1a1a)" },
    ...
    closeBtn: { width: 20, height: 20, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", border: "none", background: "transparent", fontSize: 12, borderRadius: "var(--radius-ui)" },
    ...
    input: { flex: 1, height: 22, padding: "0 22px 0 4px", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", fontSize: 12, textAlign: "right" as const, outline: "none", background: "#fff" },
    ...
    select: { flex: 1, height: 22, padding: "0 4px", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", fontSize: 12, background: "#fff", outline: "none" },
    sectionTitle: { fontSize: 11, fontWeight: 600, color: "var(--c-t2, #444)", borderBottom: "1px solid #e5e5e5", paddingBottom: 3, marginTop: 4 },
    stats: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3px 10px", padding: "7px 9px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "var(--radius-ui)", fontSize: 11 },
    statLabel: { color: "var(--c-t3, #64748b)" },
    statVal: { fontWeight: 600, textAlign: "right" as const },
    verdict: { padding: "7px 9px", borderRadius: "var(--radius-ui)", fontSize: 11, lineHeight: 1.45, background: verdictBg, border: `1px solid ${verdictBorder}`, color: verdictColor },
    ...
    btnOk: (on: boolean) => ({ height: 26, padding: "0 18px", fontSize: 12, background: on ? "var(--c-blue-bg, #2563eb)" : "#e5e5e5", color: on ? "#fff" : "#999", border: `1px solid ${on ? "var(--c-blue, #1d4ed8)" : "#ccc"}`, borderRadius: "var(--radius-ui)", cursor: on ? "pointer" : "default", fontWeight: 600 }),
    btnCancel: { height: 26, padding: "0 14px", fontSize: 12, background: "#f5f5f5", border: "1px solid var(--c-b3, #aaa)", borderRadius: "var(--radius-ui)", cursor: "pointer" },

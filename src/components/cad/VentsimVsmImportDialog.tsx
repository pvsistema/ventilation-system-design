...
import { parseVentsimVsm, type VentsimVsmResult } from "@/lib/import/ventsimVsmImport";
import Icon from "@/components/ui/icon";

interface Props {
  onImport: (result: VentsimVsmResult, mode: "replace" | "append") => void;
  onClose: () => void;
}

export default function VentsimVsmImportDialog({ onImport, onClose }: Props) {
  const [result, setResult] = useState<VentsimVsmResult | null>(null);

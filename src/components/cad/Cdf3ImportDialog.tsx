...
interface Props {
  onImport: (result: Cdf3ImportResult, mode: "replace" | "append") => void;
  onClose: () => void;
}

export default function Cdf3ImportDialog({ onImport, onClose }: Props) {
  const [result, setResult] = useState<Cdf3ImportResult | null>(null);

...
ALPHA_DEFAULT = 100  # ×10^-4 Н·с2/м4 — «другие виды крепи»
...
def kz_from_alpha(alpha):
    """Коэффициент затухания Кз по табл. 3. α в программе хранится в тех же
    единицах ×10^-4 Н·с2/м4, что и A в таблице, — A = α без пересчёта."""
